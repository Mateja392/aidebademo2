...
const Industries = () => {
  ...
  return (
    <section className="section-container bg-ai-grey-light/30" id="industries">
      <motion.div 
      ...
      >
        ...
        <motion.p 
          className="text-lg text-ai-grey mb-12 max-w-2xl mx-auto"
          variants={itemVariants}
        >
          We specialize in automating processes for businesses across these key sectors
        </motion.p>
